...
and
((F_C_year > 2004) or (F_C_year is null))),
a2006 as(
...
and
((F_C_year > 2005) or (F_C_year is null))),
a2007 as(
...
and
((F_C_year > 2006) or (F_C_year is null))),
a2008 as(
...
and
((F_C_year > 2007) or (F_C_year is null))),
a2009 as(
...
and
((F_C_year > 2008) or (F_C_year is null))),
a2010 as(
...
and
((F_C_year > 2009) or (F_C_year is null))),
a2011 as(
...
and
((F_C_year > 2010) or (F_C_year is null))),
T as(
select * from a2005
union all
select * from a2006
